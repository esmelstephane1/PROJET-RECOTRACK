                ...
                <div class="input-group input-group-merge search-bar">
                  <span class="input-group-text" id="topbar-addon"><svg class="icon icon-xs"
                      ...
                      <path fill-rule="evenodd"
                        ...
                        clip-rule="evenodd"></path>
                    </svg> </span><input type="text" class="form-control" id="topbarInputIconLeft" placeholder="Search"
            ...
            <ul class="navbar-nav align-items-center">
              <li class="nav-item dropdown">
                <a class="nav-link text-dark notification-bell unread dropdown-toggle" data-unread-notifications="true"
                  href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false"><svg
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-center mt-2 py-0">
                  <div class="list-group list-group-flush">
                    ...
                    </a><a href="../single-message.html" class="list-group-item list-group-item-action border-bottom">
                      <div class="row align-items-center">
                        <div class="col-auto">
                          <!-- Avatar -->
            ...
            <div class="card-body">
              <div class="row d-block d-xxl-flex align-items-center">
                ...
                <div class="col-12 col-xxl-6 ps-xxl-4 pe-xxl-0">
                  ...
                  <small class="d-flex align-items-center"><svg class="icon icon-xxs text-gray-400 me-1"
                      fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd"
                    ...
                    <div>
                      <svg class="icon icon-xs text-success" fill="currentColor" viewBox="0 0 20 20"
                        ...
                        <path fill-rule="evenodd"
                          ...
                          clip-rule="evenodd"></path>
                      </svg><span class="text-success fw-bolder">18,2%</span> Since
                      last month
                    </div>
                  </div>
                </div>
                    ...
                    <div>
                      <svg class="icon icon-xs text-danger" fill="currentColor" viewBox="0 0 20 20"
                        ...
                        <path fill-rule="evenodd"
                          ...
                          clip-rule="evenodd"></path>
                      </svg><span class="text-danger fw-bolder">4,6%</span> Since
                      last month
                    </div>
                  </div>
                </div>
                    ...
                    <div>
                      <svg class="icon icon-xs text-success" fill="currentColor" viewBox="0 0 20 20"
                        ...
                        <path fill-rule="evenodd"
                          d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z"
                          clip-rule="evenodd"></path>
                      </svg><span class="text-success fw-bolder">20%</span> Since
                      last month
                    </div>
                  </div>
                </div>
        ...
        <div class="col-12 col-xxl-4 mb-4">
          <div class="card border-0 shadow">
            ...
            <div class="card-body text-center py-4 py-xl-5">
              ...
              <a href="#" class="btn btn-primary d-inline-flex align-items-center"><svg class="icon icon-xxs me-2"
                  fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd"
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar-md"><img class="rounded" alt="Image placeholder"
                ...
                <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar-md"><img class="rounded" alt="Image placeholder"
                          src="../../assets/img/team/profile-picture-5.jpg" /></a>
                    </div>
                    <div class="col-auto px-0">
                      <h4 class="fs-6 text-dark mb-0">
                ...
                <li class="list-group-item bg-transparent border-bottom py-3 px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar-md"><img class="rounded" alt="Image placeholder"
                          src="../../assets/img/team/profile-picture-6.jpg" /></a>
                    </div>
                    <div class="col-auto px-0">
                      <h4 class="fs-6 text-dark mb-0">
                ...
                <li class="list-group-item bg-transparent py-3 px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar-md"><img class="rounded" alt="Image placeholder"
                          src="../../assets/img/team/profile-picture-7.jpg" /></a>
                    </div>
                    <div class="col-auto px-0">
                      <h4 class="fs-6 text-dark mb-0">
        ...
        <div class="col-12 col-md-6 col-xxl-4 mb-4">
          <div class="card notification-card border-0 shadow">
            <div class="card-header d-flex align-items-center">
              ...
              <div class="ms-auto">
                <a class="fw-normal d-inline-flex align-items-center" href="#"><svg class="icon icon-xxs me-2"
                    fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"></path>
                    <path fill-rule="evenodd"
                      d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z"
                  ...
                  <ul class="list-group list-group-flush list my--3">
                    ...
                    <li class="list-group-item px-0">
                      <div class="row align-items-center">
                        <div class="col-auto">
                          <!-- Avatar -->
                          <a href="../users.html" class="avatar"><img class="rounded-circle" alt="Image placeholder"
                              src="../../assets/img/team/profile-picture-2.jpg" /></a>
                        </div>
                        <div class="col-auto ms--2">
                    ...
                    <li class="list-group-item px-0">
                      <div class="row align-items-center">
                        <div class="col-auto">
                          <!-- Avatar -->
                          <a href="#" class="avatar"><img class="rounded-circle" alt="Image placeholder"
                              src="../../assets/img/team/profile-picture-3.jpg" /></a>
                        </div>
                        <div class="col-auto ms--2">
              ...
              <div class="card border-0 shadow">
                ...
                <div class="card-body">
                  ...
                  <div class="row align-items-center d-block d-sm-flex border-bottom pb-4 mb-4">
                    <div class="col-auto mb-3 mb-sm-0">
                      <div class="calendar d-flex">
                        <span class="calendar-month">Aug</span><span class="calendar-day py-2">10</span>
                      </div>
                    </div>
                    <div class="col">
                  ...
                  <div class="row align-items-center d-block d-sm-flex border-bottom pb-4 mb-4">
                    <div class="col-auto mb-3 mb-sm-0">
                      <div class="calendar d-flex">
                        <span class="calendar-month">Sep</span><span class="calendar-day py-2">12</span>
                      </div>
                    </div>
                    <div class="col">
                      <a href="../calendar.html">
                  ...
                  <div class="row align-items-center d-block d-sm-flex border-bottom pb-4 mb-4">
                    <div class="col-auto mb-3 mb-sm-0">
                      <div class="calendar d-flex">
                        <span class="calendar-month">Sep</span><span class="calendar-day py-2">15</span>
                      </div>
                    </div>
                    <div class="col">
                      <a href="../calendar.html">
                  ...
                  <div class="row d-block d-sm-flex align-items-center">
                    <div class="col-auto mb-3 mb-sm-0">
                      <div class="calendar d-flex">
                        <span class="calendar-month">Sep</span><span class="calendar-day py-2">28</span>
                      </div>
                    </div>
                    <div class="col">
                      <a href="../calendar.html">
                ...
                <div class="card-footer border-top bg-gray-50">
                  <a class="fw-bold d-flex align-items-center justify-content-center" href="../calendar.html"><svg
            ...
            <div class="card border-0 shadow">
              ...
              <div class="card-body py-4">
                <div class="row align-items-center mb-4">
                  <div class="col-auto">
                    <!-- Avatar -->
                    <a href="#" class="image image-xs rounded-circle"><img alt="Image placeholder"
                  ...
                  <div class="col">
                    <div class="progress-wrapper">
                      <div class="progress-info">
                        <div class="h6 mb-0">
                          United States
                          <span class="text-gray-500 font-small">(272.109)</span>
                        </div>
                  ...
                  <div class="col">
                    <div class="progress-wrapper">
                      <div class="progress-info">
                        <div class="h6 mb-0">
                          Canada
                          <span class="text-gray-500 font-small">(160.064)</span>
                        </div>
                  ...
                  <div class="col">
                    <div class="progress-wrapper">
                      <div class="progress-info">
                        <div class="h6 mb-0">
                          Germany
                          <span class="text-gray-500 font-small">(120.048)</span>
                        </div>
                  ...
                  <div class="col">
                    <div class="progress-wrapper">
                      <div class="progress-info">
                        <div class="h6 mb-0">
                          France
                          <span class="text-gray-500 font-small">(100.048)</span>
                        </div>
                  ...
                  <div class="col">
                    <div class="progress-wrapper">
                      <div class="progress-info">
                        <div class="h6 mb-0">
                          Japan
                          <span class="text-gray-500 font-small">(56.022)</span>
                        </div>
                  ...
                  <div class="col">
                    <div class="progress-wrapper">
                      <div class="progress-info">
                        <div class="h6 mb-0">
                          Italy
                          <span class="text-gray-500 font-small">(48.019)</span>
                        </div>
                  ...
                  <div class="col">
                    <div class="progress-wrapper">
                      <div class="progress-info">
                        <div class="h6 mb-0">
                          Netherlands
                          <span class="text-gray-500 font-small">(40.016)</span>
                        </div>
                  ...
                  <div class="col">
                    <div class="progress-wrapper">
                      <div class="progress-info">
                        <div class="h6 mb-0">
                          Sweden
                          <span class="text-gray-500 font-small">(26.016)</span>
                        </div>
